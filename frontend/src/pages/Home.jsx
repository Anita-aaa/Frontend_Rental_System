    ...
    <div className='w-full h-screen bg-[#f7f7f8]' style={{ fontFamily: "'Exo 2', sans-serif" }}>
      ...
      <div className='w-full  h-screen bg-[#f7f7f8] flex   items-center'>
        <div className='w-1/2 px-2  ml-20 items-center justify-center'>
          <h1 className='text-9xl text-[#2a7f62] text-bold mb-3'>FarmBuddy</h1>
          <h2 className='text-3xl text-[#41676a]'>Your Partner in Prosperous Farming</h2>
          <h2 className='text-xl text-zinc-600 mt-4'>FarmBuddy is dedicated to supporting farmers on their path to bountiful harvests. We provide easy access to essential tools through our rental platform, enhancing productivity and profitability. Together, let's cultivate a future where sustainable farming flourishes, creating a legacy of growth and prosperity for all farmers.</h2>
