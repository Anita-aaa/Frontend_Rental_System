      ...
      <div className='flex flex-col justify-center items-center caret-transparent' >
        <div className="container flex-col  mt-24 px-4">
          ...
          <div className='flex justify-evenly space-x-96'>
            ...
            <img className='h-40 w-40 rounded-lg border-4 shadow-sm border-green-300 hover:border-teal-500 transition duration-300' src="../src/assets/logo.png" alt="" />
          </div>
        ...
        <div className='flex space-x-4  p-24 mt-4'>
          ...
          <div className="w-full md:w-1/2 bg-teal-200 p-8 rounded-lg shadow-md">
            <h1 className="text-3xl font-semibold mb-4">FarmBuddy</h1>
            <p className="text-lg mb-6">FarmBuddy connects farmers with a diverse range of rental machinery, facilitating seamless transactions for increased productivity and reduced costs.</p>
