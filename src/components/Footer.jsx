    ...
    return (
        <div className=' p-2 px-8 w-full border-t border-zinc-500  flex items-center bg-[#f7f7f8b8]  bottom-0 z-10'>
            <div className='flex align-center items-center justify-start gap-2 w-1/3'>
                ...
                <h2 className='text-3xl text-zinc-800 font-bold'>FarmBuddy</h2>
            </div>

            <div className='flex  gap-4 justify-between w-1/2'>
                <div className='flex flex-col items-start justify-start  w-1/3'>
                    <h1 >Project</h1>
                    <h1 className='hover:bg-[#b2d8b4 ] p-1 rounded-md' onClick={() => navigate("/workflow")}>How it works</h1>
                ...
                <div className='flex flex-col items-start justify-start  w-1/3'>
                    <h1 >About us</h1>
                    <h1 className='hover:bg-[#b2d8b4 ] p-1 rounded-md' onClick={() => navigate("/help")}>Help</h1>
                    <h1 className='hover:bg-[#b2d8b4 ] p-1 rounded-md' onClick={() => navigate("/faq")}>FAQs</h1>
                    <h1 className='hover:bg-[#b2d8b4 ] p-1 rounded-md' onClick={() => navigate("/contact")}>Contact</h1>
                </div>
                <div className='flex flex-col items-start justify-start  w-1/3'>
                    <h1 >Privacy</h1>
            ...
            <div className='flex flex-col items-end justify-end w-1/3'>
                <button onClick={handleClick} className="bg-[#b2d8b4 ] hover:bg-[#9fd39b] text-black font-bold py-2 px-4 rounded mb-5">Get Started</button>
