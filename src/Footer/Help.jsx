...
const Help = () => {
  ...
  const booking_help = [
    {
      heading: "Q: How do I book an equipment on FarmBuddy",
      content:
    ...
    },
    {
      ...
      content:
        "A: A penalty will be applicable for the amount of time you are late.",
    },
    {
  ...
  const renting_help = [
    ...
    },
    {
      ...
      content:
        "A: You can refund your payments or amount by logging to your stripe account affiliated to FarmBuddy.",
    },
    {
      heading: "Q: What types of equipment can I list for booking?",
      content:
        "A: You can post all types of farming eqipment on FarmBuddy. For Example, Trucks, Tractors, etc.",
    },
  ];
    ...
    <div className="">
      ...
      <div className="w-100">
        <div className="p-9 flex w-screen">
          ...
          <button onClick={goContactPage} className="px-6 py-1 rounded-lg ml-auto text-white text-xl font-semibold hover:bg-green-700 bg-[#68AC5D]">
            Contact Us
          </button>
        </div>
      </div>
